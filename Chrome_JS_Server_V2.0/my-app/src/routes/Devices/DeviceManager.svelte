...
<div class= 'flex justify-start flex-wrap'>
    <div>
        ...
        <input type="text" id="devId" placeholder='0x0001' class= 'bg-gray-dark rounded-md px-3 py-1 m-3 w-20 font-semibold'>
    </div>
    <div>
        <label for="deviceName" class= 'font-semibold pl-4'>Device Name</label>
        <input type="text" id="deviceName" placeholder='' class= 'bg-gray-dark rounded-md px-3 py-1 m-3 w-48 font-semibold'>
    </div>
</div>
