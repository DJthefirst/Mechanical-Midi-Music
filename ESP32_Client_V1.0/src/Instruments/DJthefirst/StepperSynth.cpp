...
// void StepperSynth::setPitchBend(uint8_t instrument, uint16_t bend){
...
//     addrLEDs.setLedsOn(instrument*5, instrument*5+4, color);
// }

// //Set an Instrument Led to off
// void StepperSynth::setInstumentLedOff(uint8_t instrument){
//     addrLEDs.setLedsOn(instrument*5, instrument*5+4, CHSV(0,0,0));
// }
