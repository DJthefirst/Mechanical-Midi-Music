...
using std::int8_t;
    ...
    #define INSTRUMENT_TYPE Teensy41_SwPWM
#endif

/* Outputs a PWM signal at the Notes Frequency on each Digital IO Pin using Teensy IntervalTimer */
class Teensy41_SwPWM : public InstrumentControllerBase{
protected:
    static void Tick();
    ...
    static std::array<uint16_t,HardwareConfig::MAX_NUM_INSTRUMENTS> m_currentTick; //Timing
