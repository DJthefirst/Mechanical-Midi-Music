...
// static std::array<bool,MAX_NUM_INSTRUMENTS> m_pinStateStep; //IO For Step Pins
// static std::array<bool,MAX_NUM_INSTRUMENTS> m_pinStateDir; //IO For Direction Pins

// static std::array<uint8_t,MAX_NUM_INSTRUMENTS> m_headPosition; //Position of Drive Head
// static const uint8_t m_maxHeadPos = 0; 
// static const uint8_t m_minHeadPos = 158; 
...
//     m_pinStateStep[instrument] ? m_headPosition[instrument]-- : m_headPosition[instrument]++;
...
//         digitalWrite(pins[instrument*2+1], m_pinStateStep[instrument*2+1]);
//     }

//     //Pulse the step pin.
//     m_pinStateStep[instrument] = !m_pinStateStep[instrument];
//     digitalWrite(pins[instrument*2], m_pinStateStep[instrument*2]);
